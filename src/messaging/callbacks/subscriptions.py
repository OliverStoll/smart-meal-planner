...
class SubscriptionHandler:
    ...
    def send_subscription_messages(self):
        ...
        for chat_id, num_meals in subscriptions.items():
            self.message_handler.send_full_recipes_message(chat_id=chat_id, num_meals=num_meals)
    ...
    def set_user_subscription(self, chat_id, num_meals):
        ...
        self.firebase_client.set_entry(ref=ref, data={"num_meals": num_meals})
    ...
    def get_all_subscriptions(self):
        ...
        subscription = {
            ...
            for chat_id, subscription_obj in subscriptions_data.items()
            if subscription_obj.get("num_meals", 0) > 0
        }
